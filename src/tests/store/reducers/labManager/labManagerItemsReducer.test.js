...
import labManagerItemsReducer from '../../../../store/reducers/labManagerReducers/labManagerItemsReducer';

describe('Lab Manager - Items Reducer', () => {
  const initialState = {
    items: [],
  ...
  it('returns the initial state when an action type is not passed', () => {
    const reducer = labManagerItemsReducer(undefined, {});

    expect(reducer).toEqual(initialState);
  });

  it('handles RESET_ITEMS_STATE event as expected', () => {
    const reducer = labManagerItemsReducer(initialState, {
  ...
  it('handles RESET_NEW_ITEM_STATE event as expected', () => {
    ...
    const reducer = labManagerItemsReducer(testStartState, {
