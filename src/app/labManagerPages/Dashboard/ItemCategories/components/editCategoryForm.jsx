...
} from '../../../../../store/actions/labManager/labManagerDashboardActions';
...
function EditCategoryForm({ category, onSubmitSuccess, onClose }) {
  ...
  const editLoading = useSelector(
    state => state.labManagerDashboard.editCategoryLoading,
  );
  const editSuccess = useSelector(
    state => state.labManagerDashboard.editCategorySuccess,
  );
  const editError = useSelector(
    state => state.labManagerDashboard.editCategoryError,
  );
